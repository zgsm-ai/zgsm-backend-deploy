...
class Users(BaseModel):
    ...
    username = CharField(null=True, verbose_name='Username')
    display_name = CharField(null=True, verbose_name='Display Name', help_text='Name + Account')
    ...
    is_plus = BooleanField(default=False, verbose_name='Has Plus Permission')
