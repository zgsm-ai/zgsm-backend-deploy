#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Find the initial template of the question that may have problems with the code
...
# Find the continuous question template that may have problems with the code
RESPONSE_PROMPT = """
"""
