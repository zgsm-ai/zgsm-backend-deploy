...
class StrUtil:
    ...
    def find_best_match(cls, prefix_list, text):
        """
        Find the string in prefix_list that matches the most characters with string a.
        # Example usage
        ...
        :return: The string that matches the most characters with a
        """
        best_match = ""
        max_match_length = 0
    ...
    def is_filled_url(cls, template_url, filled_url):
        """
        Determine whether a URL string is the result of filling another URL string with placeholders.
        # Example usage
        ...
        :return:
        """
        # Replace placeholders with wildcards in regular expressions
    ...
    def remove_url_params(cls, url):
        """
        Remove the parameter part from the URL, but keep the method parameters
