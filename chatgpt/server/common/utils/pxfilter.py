# -*- coding: utf-8 -*-
"""
Python Rich Text XSS Filtering Class
@package XssHtml
@version 0.1
...
Browser version: IE7+ or other browsers, cannot defend against XSS in browsers below IE6
"""
import re
...
if "__main__" == __name__:
    parser = XssHtml()
    test = '<a onmouseover="alert(1)">test</a><!-- bbb -->'
    print(parser.filter(test))
