...
oidc:
  ...
  auth_url: http://keycloak:{{PORT_KEYCLOAK_INTERNAL}}/auth/realms/master/protocol/openid-connect/auth
  token_url: http://keycloak:{{PORT_KEYCLOAK_INTERNAL}}/auth/realms/master/protocol/openid-connect/token
  user_info_url: http://keycloak:{{PORT_KEYCLOAK_INTERNAL}}/auth/realms/master/protocol/openid-connect/userinfo
