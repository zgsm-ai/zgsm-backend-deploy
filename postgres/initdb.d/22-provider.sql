...
-- Records of provider
-- ----------------------------
INSERT INTO "public"."provider" VALUES ('user-group', 'Github', '2025-07-03T00:26:21+08:00', 'Github', 'OAuth', 'GitHub', '', 'Normal', 'test-id', 'test-secret', '', '', '', '', '', '', '', '', '{"avatarUrl":"avatarUrl","displayName":"displayName","email":"email","id":"id","username":"username"}', 'null', '', 0, 'f', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'f', '', 'https://github.com/organizations/xxx/settings/applications/1234567');
INSERT INTO "public"."provider" VALUES ('user-group', 'provider_captcha_default', '2025-07-02T08:28:07Z', 'Captcha Default', 'Captcha', 'Default', '', '', '', '', '', '', '', '', '', '', '', '', '{"avatarUrl":"avatarUrl","displayName":"displayName","email":"email","id":"id","username":"username"}', 'null', '', 0, 'f', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'f', '', '');
INSERT INTO "public"."provider" VALUES ('user-group', 'SMS', '2025-07-02T16:30:02+08:00', 'SMS', 'SMS', 'Custom HTTP SMS', '', 'POST', '', '', '', '', '', '', '', '', '', '', '{"avatarUrl":"avatarUrl","displayName":"displayName","email":"email","id":"id","username":"username"}', 'null', '', 0, 'f', 'code', 'CN', '', '', '', '', '', 'http://casdoor.shenma.svc.cluster.local:8000/oidc-auth/api/v1/send/sms', '', '', '', '', '', '', '', 'f', '', '');
